      ...
      <transition name="fade">
        <v-card class="title-screen">
          ...
          <transition-group name="sliding" tag="div" class="animaline">
                <inline-svg v-if="this.animalsList.includes(6)" :src="require('../assets/img/029-goat.svg')" :key="6" width="50" height="50" class="align-self-end"/>
                ...
                <inline-svg v-if="this.animalsList.includes(6)" :src="require('../assets/img/029-goat.svg')" :key="5" width="50" height="50" class="align-self-end"/>
                <inline-svg v-if="this.animalsList.includes(7)" :src="require('../assets/img/029-goat.svg')" :key="7" width="50" height="50" class="align-self-end"/>
          </transition-group> 
          <transition-group name="sliding" tag="div" class="animaline">
                <inline-svg v-if="this.animalsList.includes(2)" :src="require('../assets/img/046-lion.svg')" :key="2" width="110" height="100" class="align-self-end"/>
                <inline-svg v-if="this.animalsList.includes(3)" :src="require('../assets/img/022-elephant.svg')" :key="3" width="120" height="120" class="align-self-end"/>
          </transition-group> 
          </div>
        </v-card>
      </transition>
