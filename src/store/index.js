...
const state = {
  ...
  // ----------------
  tasks : [
    { title: i18n.t('task.kingcloths.t'),
      description: i18n.t('task.kingcloths.d'),
      active: 0,
      avatar: require("@/assets/img/046-lion.svg"),
      data: [
        { 
          title: i18n.t('task.kingcloths.1.t'),
          fen: '8/p6p/8/8/8/8/8/4K3 w - - 0 1',
          description: i18n.t('task.kingcloths.1.d'),
          orientation: 'white',
          id: '1bdf210a-32b8-4112-89eb-596475f4e67a',
        },
        { 
          title: i18n.t('task.kingcloths.2.t'),
          fen: '8/1p4p1/8/8/8/8/8/4K3 w - - 0 1',
          description: i18n.t('task.kingcloths.2.d'),
          orientation: 'white',
          id: '297853ad-fc48-4137-8eaf-127c52984eb9',
        },
        { 
          title: i18n.t('task.kingcloths.3.t'),
          fen: '8/2p2p2/8/8/8/8/8/4K3 w - - 0 1',
          description: i18n.t('task.kingcloths.3.d'),
          orientation: 'white',
          id: '28ae8cd0-7895-474a-9baf-da2fdef8707c',
        },
        { 
          title: i18n.t('task.kingcloths.4.t'),
          fen: '8/3pp3/8/8/8/8/8/4K3 w - - 0 1',
          description: i18n.t('task.kingcloths.4.d'),
          orientation: 'white',
          id: '38666cf2-b286-4005-80ef-20abbeae35e5',
        },
        { 
          title: i18n.t('task.kingcloths.5.t'),
          fen: '8/3ppp2/8/8/8/8/8/4K3 w - - 0 1',
          description: i18n.t('task.kingcloths.5.d'),
          orientation: 'white',
    ...
    { title: i18n.t('task.wolfkids.t'),
      description: i18n.t('task.wolfkids.d'),
      active: 0,                
      ...
      data: [
        { 
          title: i18n.t('task.wolfkids.1.t'),
          fen: '4r3/8/8/8/8/8/3PPP2/8 w - - 0 1',
          description: i18n.t('task.wolfkids.1.d'),
          orientation: 'white',
          id: '157ca1d8-09eb-45dc-9529-668bb5562fa7',
        },
        { 
          title: i18n.t('task.wolfkids.2.t'),
          fen: '3q4/8/8/8/8/8/PPPPPPPP/8 w - - 0 1',
          description: i18n.t('task.wolfkids.2.d'),
          orientation: 'white',
        ...
        { 
          title: i18n.t('task.wolfkids.3.t'),
          fen: '3r4/8/8/8/8/8/2PPPP2/8 w - - 0 1',
          description: i18n.t('task.wolfkids.3.d'),
          orientation: 'white',
          id: '21386bed-d3ed-4ee0-afd3-b59b6d7dd8cc', 
        },
        { 
          title: i18n.t('task.wolfkids.4.t'),
          fen: '3r4/8/8/8/8/8/1PPPPP2/8 w - - 0 1',
          description: i18n.t('task.wolfkids.4.d'),
          orientation: 'white',
          id: '50096326-6ea6-4c5b-b289-9b004a432df7', 
        },
        { 
          title: i18n.t('task.wolfkids.5.t'),
          fen: '3r4/8/8/8/8/8/1PPPPPP1/8 w - - 0 1',
          description: i18n.t('task.wolfkids.5.d'),
          orientation: 'white',
    ...
    { title: i18n.t('task.elephant.t'),
      description: i18n.t('task.elephant.d'),
      active: 0,                
      avatar: require("@/assets/img/022-elephant.svg"),
      data: [
        { 
          title: i18n.t('task.elephant.1.t'),
          fen: '8/3pp3/8/8/8/8/8/2B5 w - - 0 1',
          description: i18n.t('task.elephant.1.d'),
          orientation: 'white',
          id: '8d243eac-f466-4472-9061-455c0a4e6b1e', 
        },
        { 
          title: i18n.t('task.elephant.2.t'),
          fen: '8/3pp3/8/8/8/8/8/5B2 w - - 0 1',
          description: i18n.t('task.elephant.2.d'),
          orientation: 'white',
          id: 'ca18abbf-ccff-4b69-8a7c-b000d8fa8bd1', 
        },
        {
          title: i18n.t('task.elephant.3.t'),
          fen: '8/3p1p2/8/8/8/8/8/2B5 w - - 0 1',
          description: i18n.t('task.elephant.3.d'),
          orientation: 'white',
          id: 'c805e418-ed0c-4589-be9f-4be622cdf9a7', 
        },
        {
          title: i18n.t('task.elephant.4.t'),
          fen: '8/3p1p2/8/8/8/8/8/5B2 w - - 0 1',
          description: i18n.t('task.elephant.4.d'),
          orientation: 'white',
          id: '6bf4def0-975f-4651-bc04-62fa0a371d34',
        },
        {
          title: i18n.t('task.elephant.5.t'),
          fen: '8/2p2p2/8/8/8/8/8/2B5 w - - 0 1',
          description: i18n.t('task.elephant.5.d'),
          orientation: 'white',
          id: '2b414e79-9913-43ca-a813-41caca4209eb',
        },
        {
          title: i18n.t('task.elephant.6.t'),
          fen: '8/2p2p2/8/8/8/8/8/5B2 w - - 0 1',
          description: i18n.t('task.elephant.6.d'),
          orientation: 'white',
          id: '6ef817b4-218c-4446-a22c-39aaa9458dd0',
        },
        {
          title: i18n.t('task.elephant.7.t'),
          fen: '8/1p4p1/8/8/8/8/8/2B5 w - - 0 1',
          description: i18n.t('task.elephant.7.d'),
          orientation: 'white',
          id: 'c13703a7-e327-4aae-b366-70d76bcb4f57',
        },
        {
          title: i18n.t('task.elephant.8.t'),
          fen: '8/1p4p1/8/8/8/8/8/5B2 w - - 0 1',
          description: i18n.t('task.elephant.8.d'),
          orientation: 'white',
          id: 'd20da7dc-39ef-40c1-b994-d50a32c5a02b',
        },
        {
          title: i18n.t('task.elephant.9.t'),
          fen: '8/p6p/8/8/8/8/8/2B5 w - - 0 1',
          description: i18n.t('task.elephant.9.d'),
          orientation: 'white',
          id: 'b8c5216d-c40e-442a-8802-1248b43055a7',
        },
        {
          title: i18n.t('task.elephant.10.t'),
          fen: '8/p6p/8/8/8/8/8/5B2 w - - 0 1',
          description: i18n.t('task.elephant.10.d'),
          orientation: 'white',
          id: '26072c3a-9ade-4f12-a2e9-2af86993a282',
        },
        {
          title: i18n.t('task.elephant.11.t'),
          fen: '8/2ppp3/8/8/8/8/8/2B5 w - - 0 1',
          description: i18n.t('task.elephant.11.d'),
          orientation: 'white',
          id: '6948c3b4-955c-44c7-b36a-3913f64e1d1c',
        },
        {
          title: i18n.t('task.elephant.12.t'),
          fen: '8/3ppp2/8/8/8/8/8/5B2 w - - 0 1',
          description: i18n.t('task.elephant.12.d'),
          orientation: 'white',
    ...
    { title: i18n.t('task.foxes.t'),
      description: i18n.t('task.foxes.d'),
      active: 0,
    ...
    { title: i18n.t('task.animals.t'),
      description: i18n.t('task.animals.d'),
      active: 0,
      ...
      data: [
        { 
          title: i18n.t('task.animals.1.t'),
          fen: '2b3n1/8/8/8/8/8/2PPPP2/8 w - - 0 1',
          description: i18n.t('task.animals.1.d'),
          orientation: 'white',
          id: 'c3d3971c-2914-4783-92a6-02e29cf694f9',
        },
        { 
          title: i18n.t('task.animals.2.t'),
          fen: '1n3b2/8/8/8/8/8/2PPPP2/8 w - - 0 1',
          description: i18n.t('task.animals.2.d'),
          orientation: 'white',
          id: '8a8c1697-65c8-4365-89ab-ef0543fe7ebc',
        },
        { 
          title: i18n.t('task.animals.3.t'),
          fen: '2b3n1/8/8/8/8/8/2PPPPP1/8 w - - 0 1',
          description: i18n.t('task.animals.3.d'),
          orientation: 'white',
          id: '322c7b6a-4323-4993-8f07-b063e15ac775',
        },
        { 
          title: i18n.t('task.animals.4.t'),
          fen: '1n3b2/8/8/8/8/8/2PPPPP1/8 w - - 0 1',
          description: i18n.t('task.animals.4.d'),
          orientation: 'white',
    ...
    { title: i18n.t('task.war.t'),
      description: i18n.t('task.war.d'),
      active: 0,                
    ...
    { title: i18n.t('task.kings.t'),
      description: i18n.t('task.kings.d'),
      active: 0,
      ...
      data: [
        { 
          title: i18n.t('task.kings.1.t'),
          fen: '4k3/8/8/8/8/8/4P3/4K3 w - - 0 1',
          description: i18n.t('task.kings.1.d'),
          orientation: 'white',
        ...
        { 
          title: i18n.t('task.kings.2.t'),
          fen: '4k3/4p3/8/8/8/8/8/4K3 w - - 0 1',
          description: i18n.t('task.kings.2.d'),
          orientation: 'white',
        ...
        { 
          title: i18n.t('task.kings.3.t'),
          fen: '4k3/8/8/8/8/4P3/8/4K3 w - - 0 1',
          description: i18n.t('task.kings.3.d'),
          orientation: 'white',
  ...
  standard:  { 
    title: i18n.t('task.std.t'),
    fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
    description: i18n.t('task.std.d'),
    orientation: 'white',
